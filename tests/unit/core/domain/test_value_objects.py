...
class TestCoordinate3D:
    ...
    def test_coordinate_nan_raises_error(self):
    ...
    def test_coordinate_inf_raises_error(self):
    ...
    def test_coordinate_distance_to(self):
...
class TestVector3D:
    ...
    def test_vector_nan_raises_error(self):
    ...
    def test_vector_inf_raises_error(self):
    ...
    def test_vector_normalize_zero_raises_error(self):
    ...
    def test_vector_perpendicular(self):
