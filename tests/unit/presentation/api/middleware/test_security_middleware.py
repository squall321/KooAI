...
class TestSecurityHeadersMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_middleware_adds_security_headers(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_adds_hsts_header(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_adds_csp_header(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_adds_referrer_policy(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_removes_server_header(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_removes_powered_by_header(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_preserves_response_content(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_preserves_status_code(self, middleware: Any, mock_request: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_middleware_works_with_error_responses(self, middleware: Any, mock_request: Mock) -> None:
